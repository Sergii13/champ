...
let indexButton = 0;
bodyColumn.innerHTML = '';
for (let i = indexButton; i < index + countToVisible; i++) {
   bodyColumn.appendChild(allDrawsColumn[i]);
}
